...
class CountriesAndOriginsStatsTableComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {data: []};
    }
    ...
    loadStatsData() {
        $.ajax({
            url: 'http://stats.adm.afrostream.net/api/getCountriesAndOrigins',
            dataType: 'json',
            success: function(data) {
                this.setState({data: data.countriesAndOrigins});
            }.bind(this),
        ...
        return (
            <Table striped bordered condensed hover responsive>
                ...
                <tr>
                    <th>
                        Country/Origin
                        <a onClick={this.onClick.bind(this, 'countryAndOrigin', 'desc')}>
                            <Glyphicon style={{float: 'right'}} glyph="glyphicon glyphicon-chevron-up" />
                        </a>
                        <a onClick={this.onClick.bind(this, 'countryAndOrigin', 'asc')}>
...
export default CountriesAndOriginsStatsTableComponent;