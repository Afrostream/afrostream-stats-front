...
class CitiesStatsTableComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {data: []};
    }
    ...
    loadStatsData() {
        $.ajax({
            url: 'http://stats.adm.afrostream.net/api/getCities',
            dataType: 'json',
            success: function(data) {
                this.setState({data: data.cities});
            }.bind(this),
...
export default CitiesStatsTableComponent;