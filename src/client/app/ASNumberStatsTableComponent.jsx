...
class ASNumberStatsTableComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {data: []};
    }
    ...
    loadStatsData() {
        $.ajax({
            url: 'http://stats.adm.afrostream.net/api/getASNumbers',
            dataType: 'json',
            success: function(data) {
                this.setState({data: data.asnumbers});
            }.bind(this),
        ...
        return (
            <Table striped bordered condensed hover responsive>
                ...
                <tr>
                    <th>
                        AS Number
                        <a onClick={this.onClick.bind(this, 'ASNumber', 'desc')}>
                            <Glyphicon style={{float: 'right'}} glyph="glyphicon glyphicon-chevron-up" />
                        </a>
                        <a onClick={this.onClick.bind(this, 'ASNumber', 'asc')}>
                            <Glyphicon style={{float: 'right'}} glyph="glyphicon glyphicon-chevron-down" />
                        </a>
                    </th>
                    <th>
                        AS Name
                        <a onClick={this.onClick.bind(this, 'ASName', 'desc')}>
                            <Glyphicon style={{float: 'right'}} glyph="glyphicon glyphicon-chevron-up" />
                        </a>
                        <a onClick={this.onClick.bind(this, 'ASName', 'asc')}>
                            <Glyphicon style={{float: 'right'}} glyph="glyphicon glyphicon-chevron-down" />
                        </a>
                    </th>
                    <th>
...
export default ASNumberStatsTableComponent;